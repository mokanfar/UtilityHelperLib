...
String.prototype.numberofoccurencesin = Number.prototype.numberofoccurencesin = function (arr) {
...
Zob.prototype.getprop = function(v) {
return _.safeGet(this,v);
}

Zob.prototype.setprop = function(v) {
return _.safeSet(this,v);
}

Zob.prototype.delete = Zob.prototype.deleteprop = function(v) {
